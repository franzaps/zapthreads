...
render(() => {  
  ...
  const [anchor, setAnchor] = createSignal(options[2].name);
  ...
  return <>
    ...
    <Select class="custom" initialValue={options[2]} options={options} format={format} onChange={(e) => setAnchor(e.name)} />
