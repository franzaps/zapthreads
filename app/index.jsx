...
const options = [
  ...
  { label: "Odell fuck this dystopia", name: "note15fp4nxx0du93y9r3xp33p4zljqmq6lr8c4xls46gftkl7ul4vhdq484wr8" },
...
render(() => {
  ...
  return <>
    ...
    <Select class="custom" initialValue={options[5]} options={options} format={(item) => item.label} onChange={(e) => setAnchor(e.name)} />
    ...
    {/* web component */}
    {anchor() && <zap-threads anchor={anchor()} disable="publish,hideContent" relays={otherRelays.join(',')} npub={npub()} />}
  </>;
}, root);
