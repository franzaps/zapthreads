  ...
  describe("parseContent", () => {
    it('removes naddr if same', async () => {
      const e: UnsignedEvent = {
        ...
        "created_at": 0,
        "pubkey": "",
        "content": "awesome article\n nostr:"
      };

      let result = parseContent(e, { urlPrefixes: parseUrlPrefixes('') }, { "#a": ["30023:6e468422dfb74a5738702a8823b9b28168abab8655faacb6853cd0ee15deee93:1680612926599"] });
    ...
    it('parses a nostr url with a custom url prefix', async () => {
      ...
      let result = parseContent(e, { urlPrefixes: parseUrlPrefixes('naddr:nostr.com/') });
      expect(result).toMatch('<p><a href="https://nostr.com/naddr1qqxnzd3cxqmrzv');

      e.content = 'I love #Bitcoin';
      e.tags = [['t', 'Bitcoin']];

      result = parseContent(e);
